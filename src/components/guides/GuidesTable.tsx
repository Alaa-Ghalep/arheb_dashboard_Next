...
export default function GuidesTable() {
  const { guides, totalCount, searchQuery, setSearchQuery, loading, error } = useGuides()
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        >
          {searchQuery ? `${guides.length} من ${totalCount}` : `عدد المرشدين: ${totalCount}`}
        </span>
      </div>
      ...
      <div className="relative mb-5 max-w-sm">
        ...
        <input
          type="text"
          placeholder="ابحث باسم المرشد السياحي..."
          value={searchQuery}
            ...
            <table className="w-full text-sm text-right">
              ...
              <thead>
                <tr style={{ backgroundColor: 'var(--bg-subtle)' }}>
                  {['#', 'اسم المرشد', 'المدينة', 'تاريخ الانضمام ' ,'عدد الطلبات','الجوال','التوفر','العنوان' ,'التواجد' ].map((th) => (
                    <th
                      key={th}
                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                       ...
                       <td className="px-5 py-3" style={{ color: 'var(--text-secondary)' }}>
                        ...
                        >
                          {guide.is_active ? 'موجود' : 'غير موجود'}
                        </span>
                      </td>
                    </tr>
                  ))
